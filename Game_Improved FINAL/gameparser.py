...
def filter_words(words, skip_words):
    ...
    """
    temp = words[:] #creates list of words
    for word in words:
        if word in skip_words:
            temp.remove(word) #removes words if they are found in skip_words
    return temp #returns 'clean' words
...
def normalise_input(user_input):
    ...
    #filter_words needs 2 arguments - .split remvoes white spaces
